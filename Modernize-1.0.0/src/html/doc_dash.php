...
<body>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            <li class="sidebar-item">
              <a class="sidebar-link" href="./doc_dash.php" aria-expanded="false">
                <span>
                      ...
                      <table class="table text-nowrap mb-0 align-middle">
                        <thead class="text-dark fs-4">
                          <tr>
                            ...
                            <th class="border-bottom-0">
                              <h6 class="fw-semibold mb-0">Certification</h6>
                            </th>
                          </tr>
                        </thead>
                        <tbody id="table-data">
      ...
      .then(data => {
        ...
        data.forEach(item => {
          ...
          if (item.vaccination_status === 'Complete') {
            ...
            certificateButton.addEventListener('click', () => generateCertificate(item.baby_name, item.vaccines_list));
  ...
  function generateCertificate(babyName, vaccinesList) {
    ...
    fetch('generate_certificate.php?generate_certificate=true&baby_name=' + babyName + '&vaccines_list=' + encodeURIComponent(vaccinesList))
